duracion <- c(5,3,2,4,3)
predecesores <- list(c(), c(1), c(1), c(2), c(2,3))
n <- length(duracion)
...
plot(0,0,type="n",xlim=c(0,max(EF)+1),ylim=c(0,n+1),xlab="Tiempo",ylab="Actividad",main="CPM Ejercicio 3")
for(i in 1:n){
